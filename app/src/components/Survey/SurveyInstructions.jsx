  ...
  return (
    <div className="container-fluid survey-instructions text-black">
      ...
      <ol start={1} className="font-weight-bold text-justify instructions-list">
        <li>
          En el caso de preguntas cerradas, seleccione la opción que considere
          apropiada.
        </li>
        <li>
      ...
      <p>
        Gracias por su gentil colaboración, una vez este listo, presione el
        botón para comenzar.
      </p>
      <div className="d-flex justify-content-center h-100 mt-4">
        <Link to={to} className={"btn btn-outline-primary btn-lg"}>
