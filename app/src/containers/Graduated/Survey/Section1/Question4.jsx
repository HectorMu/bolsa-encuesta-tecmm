        ...
        <div className="col-12 col-lg-3 col-md-3 col-xl-3">
          <div className="form-check">
            <input
              ...
              type="radio"
              name={ID}
              onChange={() => handleChange("respuesta4", "Muy buena")}
              value={answers.respuesta4}
              id={`${ID}MB`}
            />
        ...
        <div className="col-12 col-lg-3 col-md-3 col-xl-3">
          <div className="form-check">
            <input
              className="form-check-input"
              type="radio"
              onChange={() => handleChange("respuesta4", "Buena")}
              value={answers.respuesta4}
              name={ID}
              id={`${ID}B`}
            />
        ...
        <div className="col-12 col-lg-3 col-md-3 col-xl-3">
          <div className="form-check">
            <input
              className="form-check-input"
              type="radio"
              onChange={() => handleChange("respuesta4", "Regular")}
              value={answers.respuesta4}
              name={ID}
              id={`${ID}R`}
            />
        ...
        <div className="col-12 col-lg-3 col-md-3 col-xl-3">
          <div className="form-check">
            <input
              className="form-check-input"
              type="radio"
              onChange={() => handleChange("respuesta4", "Mala")}
              value={answers.respuesta4}
              name={ID}
              id={`${ID}M`}
            />
